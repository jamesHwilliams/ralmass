...
h = ggplot(data, aes(Day, Height)) + geom_line() + scale 
...
gg = ggplot(data, aes(Day, GooseGrazing)) + geom_line() + scale
d = ggplot(data, aes(Day, Digestability)) + geom_line() + scale
db = ggplot(data, aes(Day, DeadBiomass)) + geom_line() + scale
gb = ggplot(data, aes(Day, GreenBiomass)) + geom_line() + scale
lat = ggplot(data, aes(Day, LATotal)) + geom_line() + scale
lag = ggplot(data, aes(Day, LAGreen)) + geom_line() + scale
w = ggplot(data, aes(Day, WeedBiomass)) + geom_line() + scale
b = ggplot(data, aes(Day, Biomass)) + geom_line() + scale
